...
uniform sampler2D u_truthTable;   // color table (nPatterns × 1): 0=dead, 1..254=rule color
...
void main() {
    ...
    // Look up color index in table (0=dead, 1..254=rule color)
    fragColor = texelFetch(u_truthTable, ivec2(idx, 0), 0).r;
}
